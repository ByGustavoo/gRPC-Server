...
public final class EstoqueServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<br.com.grpc.server.estoque.ConsultarEstoqueRequest,
      br.com.grpc.server.estoque.ConsultarEstoqueResponse> getConsultarEstoqueMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ConsultarEstoque",
      requestType = br.com.grpc.server.estoque.ConsultarEstoqueRequest.class,
      responseType = br.com.grpc.server.estoque.ConsultarEstoqueResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<br.com.grpc.server.estoque.ConsultarEstoqueRequest,
      br.com.grpc.server.estoque.ConsultarEstoqueResponse> getConsultarEstoqueMethod() {
    io.grpc.MethodDescriptor<br.com.grpc.server.estoque.ConsultarEstoqueRequest, br.com.grpc.server.estoque.ConsultarEstoqueResponse> getConsultarEstoqueMethod;
      ...
      synchronized (EstoqueServiceGrpc.class) {
        if ((getConsultarEstoqueMethod = EstoqueServiceGrpc.getConsultarEstoqueMethod) == null) {
          EstoqueServiceGrpc.getConsultarEstoqueMethod = getConsultarEstoqueMethod =
              io.grpc.MethodDescriptor.<br.com.grpc.server.estoque.ConsultarEstoqueRequest, br.com.grpc.server.estoque.ConsultarEstoqueResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ConsultarEstoque"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.grpc.server.estoque.ConsultarEstoqueRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.grpc.server.estoque.ConsultarEstoqueResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void consultarEstoque(br.com.grpc.server.estoque.ConsultarEstoqueRequest request,
        io.grpc.stub.StreamObserver<br.com.grpc.server.estoque.ConsultarEstoqueResponse> responseObserver) {
  ...
  public static final class EstoqueServiceStub
    ...
    /**
     */
    public void consultarEstoque(br.com.grpc.server.estoque.ConsultarEstoqueRequest request,
        io.grpc.stub.StreamObserver<br.com.grpc.server.estoque.ConsultarEstoqueResponse> responseObserver) {
  ...
  public static final class EstoqueServiceBlockingV2Stub
    ...
    /**
     */
    public br.com.grpc.server.estoque.ConsultarEstoqueResponse consultarEstoque(br.com.grpc.server.estoque.ConsultarEstoqueRequest request) throws io.grpc.StatusException {
  ...
  public static final class EstoqueServiceBlockingStub
    ...
    /**
     */
    public br.com.grpc.server.estoque.ConsultarEstoqueResponse consultarEstoque(br.com.grpc.server.estoque.ConsultarEstoqueRequest request) {
  ...
  public static final class EstoqueServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.com.grpc.server.estoque.ConsultarEstoqueResponse> consultarEstoque(
        br.com.grpc.server.estoque.ConsultarEstoqueRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONSULTAR_ESTOQUE:
          serviceImpl.consultarEstoque((br.com.grpc.server.estoque.ConsultarEstoqueRequest) request,
              (io.grpc.stub.StreamObserver<br.com.grpc.server.estoque.ConsultarEstoqueResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              br.com.grpc.server.estoque.ConsultarEstoqueRequest,
              br.com.grpc.server.estoque.ConsultarEstoqueResponse>(
  ...
  private static abstract class EstoqueServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.com.grpc.server.estoque.Estoque.getDescriptor();
    }
